        ...
        <div className="w-full bg-zinc-950/98 backdrop-blur-md border-b border-zinc-900 text-white transition-all duration-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/" className="flex items-center gap-3 group py-1">
                <Image
                  ...
                  width={32}
                  height={32}
                  className="rounded-full object-cover border border-[#c9a84c]/25 shadow-md"
                />
            ...
            <nav className="hidden md:flex items-center space-x-4 h-full z-40">
              <Link href="/" className="px-3 py-2 text-sm font-semibold text-zinc-300 hover:text-white transition-colors">
                Home
              </Link>
              <button
                onClick={() => setIsWishlistOpen(true)}
                className="px-3 py-2 text-sm font-semibold text-zinc-300 hover:text-white transition-colors cursor-pointer bg-transparent border-none"
              >
                My Wishlist
              </button>
              <Link href="/profile" className="px-3 py-2 text-sm font-semibold text-zinc-300 hover:text-white transition-colors">
                My Account
              </Link>
            </nav>
