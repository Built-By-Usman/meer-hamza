      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <Input {...register('firstName')} placeholder="e.g. Ahmed" className="pl-9 bg-transparent" error={!!errors.firstName} />
          </div>
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            <User className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground pointer-events-none" />
            <Input {...register('lastName')} placeholder="e.g. Khan" className="pl-9 bg-transparent" error={!!errors.lastName} />
          </div>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 max-w-lg w-full mx-auto p-6 border rounded-2xl bg-card">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            <User className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground pointer-events-none" />
            <Input {...register('fullName')} placeholder="e.g. Ahmed Khan" className="pl-9 bg-transparent" error={!!errors.fullName} />
          </div>
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <Input {...register('addressLine1')} placeholder="Street address, apartment, or house number" className="pl-9 bg-transparent" error={!!errors.addressLine1} />
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <Input {...register('city')} placeholder="e.g. Lahore" className="bg-transparent" error={!!errors.city} />
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <Input {...register('phone')} placeholder="e.g. 03001234567" className="pl-9 bg-transparent" error={!!errors.phone} />
          </div>
